...
Aux_Data_Typedef burn_data[AUX_TOTAL_FILES] =
{
  ...
  { "gamep",     "0:/icon_bin/gamep.bin",     "icon gamep",     0x314000, 2*4096, UPDATE },
  { "set",       "0:/icon_bin/set.bin",       "icon set",       0x316000, 2*4096, UPDATE },
  { "lightbulb", "0:/icon_bin/lightbulb.bin", "icon lightbulb", 0x318000, 2*4096, UPDATE },
  { "paperplane", "0:/icon_bin/paperplane.bin", "icon paperplane", 0x31A000, 2*4096, UPDATE },
